...
from controllers import read_all_users_from_mongodb,modificar_calles , event_generator1, event_generator2 , obtener_datos_historicos, eliminar_de_calles, test, encontrar_calle_mas_cercana, event_queue
...
notify_router = APIRouter(prefix="/v1/notify", tags=["notify"])
